...
2. **개인적인 후기**
   ...
   SSAFY에 입과하기 전까지 저는 실제로 작동하는 어플리케이션의 개발보다는, 학술적인 연구를 목적으로 한 프로그램의 개발 활동을 주로 하고 있었습니다. 따라서 싸피의 1학기 교육과정을 거쳐가면서 자바를 통해 웹 프로젝트의 백엔드 구성방법을 배우고, JS를 통해 프론트 환경의 구축 방법에 대해 배우는 과정이 저에게 있어서 큰 발전이었습니다.
